...
android {
    ...
    defaultConfig {
        ...
        android.defaultConfig.versionName = System.getenv("VERSION_OVERRIDE") ?: "4.5.5.0.3.0"
...
dependencies {
    ...
    // Partner SDK
    implementation("com.pangle.global:ads-sdk:5.5.0.3")
...
artifactory {
    ...
    publish {
        ...
        defaults {
            publications("PangleAdapter", "aar")
    ...
    publishing {
        publications {
            register<MavenPublication>("remoteRelease") {
                ...
                pom {
                    name.set("Chartboost Mediation Adapter Pangle")
